...
class VendorDetails extends StatefulWidget {
  ...
  String image;
   ...
   VendorDetails({super.key, required this.requestDate, required this.product, required this.specification, required this.quantity, required this.image, required this.delivery});
